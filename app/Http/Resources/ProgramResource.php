...
class ProgramResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $pain_extra_info_map = [
            ...
            5 => [
                'title' => 'Живот',
                'text' => 'Кривая спина и неправильное перераспределение веса являются главной причиной торчящего живота, который нельзя убрать с помощью диет и обычных тренировок',
            ],
            6 => [
                'title' => 'Поясница',
